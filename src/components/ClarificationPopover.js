...
function ClarificationPopover({description}) {
    const popover = (
    ...
    return (
        <OverlayTrigger trigger={["hover", "focus"]} placement="top" overlay={popover}>
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none" className="text-danger" style={{ fontSize: '24px' }}>
...
export default ClarificationPopover